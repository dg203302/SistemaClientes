...
window.onload = function(){
    ...
    if (boton_info) {
        if (valor === "0"){ //usuario invalido
            ...
            boton_s.href="/Templates/Templates_inicio_sesion_registro/iniciosesion.html"
            ...
            icono.className = "fa-solid fa-circle-xmark";
            texto_info.textContent = generarmensaje(inform);
            boton_info.href = "/Templates/Templates_inicio_sesion_registro/Registrarse.html"
            boton_info.textContent = "Reintentar"
            let contenedor = document.getElementsByClassName("informe")
            contenedor[0].classList.add("fracaso");
            console.log(inform)
            ...
            texto_info.textContent = generarmensaje(inform);
            boton_info.href = "/Templates/Templates_recuperar_contrasenia/recuperar_contra.html";
